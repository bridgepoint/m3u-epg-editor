        ...
        with open(m3u_target, "w") as text_file:
            ...
            with open(filtered_channels_name_target, "w") as filtered_channels_file:
                for entry in m3u_entries:
                    ...
                    text_file.write('pipe:///usr/bin/ffmpeg -loglevel fatal -i %s -vcodec copy -acodec copy -metadata service_provider=STRING -metadata service_name=STRING -f mpegts -tune zerolatency pipe:1 \n' % entry.url)
